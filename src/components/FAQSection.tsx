...
const faqItems = [
  {
    ...
    a: "Most projects take between 8 to 12 months depending on the complexity and type of mount. We offer a 12-month turnaround guarantee for standard mounts. Custom and full mounts may take longer. We'll provide a timeline estimate when you submit your order.",
  },
  {
  ...
  },
  {
    ...
    a: "Our combination of artisan craftsmanship, cutting-edge technology, professional communication through our outfitter portal, a 14,000 sq ft facility with 4 branches, and our 12-month turnaround guarantee sets us apart in the industry.",
  },
];
